...
mkdir /mnt/gui/
cp midpoint2/BOOT-INF/lib/admin-gui-4.8.1.jar /mnt/gui/
cd /mnt/gui/
unzip -q admin-gui-4.8.1.jar -d gui2
cp -f /mnt/page/AbstractPageLogin.html gui2/com/evolveum/midpoint/gui/impl/page/login/AbstractPageLogin.html
rm -f admin-gui-4.8.1.jar
apk add zip
cd gui2
zip -0 -r admin-gui-4.8.1.jar .
cp -f admin-gui-4.8.1.jar /mnt/lib/midpoint2/BOOT-INF/lib/
cd /mnt/lib
rm midpoint.jar
cd midpoint2
